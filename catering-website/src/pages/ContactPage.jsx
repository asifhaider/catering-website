          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div
                role="status"
                aria-live="polite"
                className="bg-white rounded-3xl border border-gray-100 shadow-sm p-10 text-center h-full flex flex-col items-center justify-center"
              >
                ...
                <form onSubmit={handleSubmit} noValidate aria-label="Contact form" className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      {errors.name && <p id="contact-name-error" role="alert" className="text-red-600 text-xs mt-1">{errors.name}</p>}
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className={inputClass}
                      />
                      {errors.email && <p id="contact-email-error" role="alert" className="text-red-600 text-xs mt-1">{errors.email}</p>}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    {errors.subject && <p id="contact-subject-error" role="alert" className="text-red-600 text-xs mt-1">{errors.subject}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {errors.message && <p id="contact-message-error" role="alert" className="text-red-600 text-xs mt-1">{errors.message}</p>}
                  </div>
